...
import {CreateSpecialistDto, SimpleSpecialistDto, UpdateSpecialistDto,} from '../../dto/specialist/specialist.dto';
...
export class SpecialistController {
    ...
    @ApiCreatedResponse({type: SimpleSpecialistDto, isArray: true, description: "Специалист"})
    @Get()
